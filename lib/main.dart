...
import 'bloc/bar_stocks/bar_stock_bloc.dart';
    ...
    return MultiRepositoryProvider(
      ...
      child: MultiBlocProvider(
        providers: [
          ...
          BlocProvider<BarSalesmanDashboardBloc>(
            create:
                (context) => BarSalesmanDashboardBloc(
                  apiService: context.read<ApiService>(),
                ),
          ),
          BlocProvider<BarStockBloc>(
            create:
                (context) =>
                    BarStockBloc(apiService: context.read<ApiService>()),
          ),
